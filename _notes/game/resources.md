...
# Resource balancing:
How do we ensure that players don't get underdeveloped in one resource,
or overdeveloped in another?  
...
## Another idea:
With this system, the player still has a chance to have "too many" 
of a certain resource, and be "stuck" with it.   
We should ALWAYS have a way to spend resources. The player should NEVER EVER feel stuck.
...
## OLD QUESTION: (keeping here for posterity)
...
It becomes very grounded, and is easier for players to intuit.

---

If we want to gatekeep upgrades behind resources,
we can do:
`SHIELD_UPGRADE (cost: $20k, 100-bones)`  

That way, it gives a clear/intuitive visual on how *expensive* the upgrade is.  
EG: in this case,
`1 bone == $200`.  Very easy for player to intuit.

Also, it provides a bit of protection:
If players (somehow) have excess bones early-game, then they won't waste them on this upgrade, (since they can't afford the money)
